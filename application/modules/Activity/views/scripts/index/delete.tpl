  ...
  <form method="POST" action="<?php echo $_SERVER['REQUEST_URI'] ?>">
    <div>
      <h3>
        ...
        <?php else: ?>
        <?php echo $this->translate("Delete This Post?") ?>
        <?php endif; ?>
      </h3>
      <p>
        <?php if (!empty($this->comment_id)): ?>
        ...
        <?php else: ?>
        <?php echo $this->translate("Are you sure that you want to delete this post and all of its comments? This action cannot be undone.") ?>
        <?php endif; ?>
