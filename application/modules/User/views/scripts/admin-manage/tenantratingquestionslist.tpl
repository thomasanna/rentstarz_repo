...
<div class='admin_results'></br>
	<li ><div><a href="<?php echo $this->url(array('action' => 'addratingquestions'));?>">Add Rating Questions</a></div></li>
	</br>
	<div class="tabs" >
	<ul class="navigation">
	<li><div><a href="<?php echo $this->url(array('action' => 'landlordratingquestionslist'));?>">Landlord</a></div></li>
	<li class="active"><div><a href="<?php echo $this->url(array('action' => 'tenantratingquestionslist'));?>">Renter</a></div></li>
	<li><div><a href="javascript:void(0)">Service</a></div></li>
	</ul>
    </div><li>
  <div>
