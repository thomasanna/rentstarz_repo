...
<div class='admin_results'>
	<div><a href="<?php echo $this->url(array('action' => 'addratingquestions'));?>">Add Rating Questions</a></div>
	<div><a href="<?php echo $this->url(array('action' => 'landlordratingquestionslist'));?>">Landlord</a></div>
	<div><a href="<?php echo $this->url(array('action' => 'tenantratingquestionslist'));?>">Renter</a></div>
