...
<li><?php echo $this->htmlLink($this->landlordUser->getHref(), $this->itemPhoto($this->landlordUser, 'thumb.icon', $this->landlordUser->getTitle()), array('title'=>$this->landlordUser->getTitle())) ?></li>	
  ...
  <li>
  <li>
    <span class="qwerty">Rental type</span> <span class="sep">:</span> <span class="xyz"> <?php echo $this->application->rental_type;?></span>  
  <li>
  <li>
    <span class="qwerty">Country</span> <span class="sep">: </span> <span class="xyz"><?php echo $this->application->prty_country;?></span>  
  <li>
  <li>
    <span class="qwerty">State</span> <span class="sep">:</span> <span class="xyz"> <?php echo $this->application->prty_state;?></span> 
  <li>
  <li>
    <span class="qwerty">City</span> <span class="sep">:</span> <span class="xyz"> <?php echo $this->application->prty_city;?> </span> 
  <li>

  <li>
    <span class="qwerty">Housing type</span> <span class="sep">: </span> <span class="xyz">   <?php echo $this->application->housing_type;?> </span> 
  <li>
  ...
  <li>
    <span class="qwerty">Pets allowed</span> <span class="sep">: </span> <span class="xyz">   <?php echo $this->application->has_pets;?> </span> 
  <li>
   <?php if($this->application->has_pets == 'Yes'):?>
  <li>
    <span class="qwerty">Type of pets</span> <span class="sep">: </span> <span class="xyz"> <?php echo $this->application->pets_type;?> </span> 
   <li>
	<?php endif;?>  
   <li>
    <span class="qwerty">Rental prices (monthly)</span> <span class="sep">: </span> <span class="xyz"> <?php echo $this->application->price;?> </span> 
   <li>
...
<div class="layput_middle_main_div">
	...
	<div class="link"><a href="/rentalapplication/<?php echo $this->application->id?>" style="color: #333;">View application</a></div>
...
<div id="profile_status">
 ...
 <div class="property_status">	
  <span style="font-size: 26px;">
     <?php echo $this->application->property_name;?>	- Rental Application
  </span>
...
<div class="pro_field_wrapper">
	...
	<input name="tenant_first_name" type="text" maxlength="65" placeholder="First Name" id="tenant_first_name" class="prty_field" autofocus value=<?php echo $this->application->tenant_firstname;?> readonly>
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Last Name <span class="mandatory">*</span></span> </span>    
	<input name="tenant_last_name" type="text" maxlength="65" placeholder="Last Name" id="tenant_last_name" class="prty_field" value=<?php echo $this->application->tenant_last_name;?> readonly>
</div><br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Email <span class="mandatory">*</span></span> </span>    
	<input name="tenant_email" type="text" maxlength="65" placeholder="Email" id="tenant_email" class="prty_field" value=<?php echo $this->application->tenant_email;?> readonly>
</div><br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Phone Number </span>    
	<input name="tenant_phone_no" type="text" maxlength="65" placeholder="Phone Number" id="tenant_phone_no" class="prty_field" value=" <?php echo $this->application->tenant_pno;?>">
</div><br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Driver's License No. </span>    
	<input name="tenant_driver_license_no" type="text" maxlength="65" placeholder="Driver's License No" id="tenant_driver_license_no" class="prty_field" value="<?php echo $this->application->driver_license_no;?>">
</div><br>
...
<div class="smartmove_rent_div" style="display:none">


<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Deposit <span class="mandatory">*</span></span>    
	<input name="Deposit" type="text" maxlength="10" placeholder="Deposit" id="Deposit" class="prty_field" value="<?php echo $this->smartmoveapiApplicationData->Deposit;?>">
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Rent <span class="mandatory">*</span></span> </span>    
	<input name="Rent" type="text" maxlength="10" placeholder="Rent" id="Rent" class="prty_field" value="<?php echo $this->smartmoveapiApplicationData->Rent;?>">
</div><br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Lease Term In Months <span class="mandatory">*</span></span> </span>    
	<input name="LeaseTermInMonths" type="text" maxlength="2" placeholder="6-12" id="LeaseTermInMonths" class="prty_field" value="<?php echo $this->smartmoveapiApplicationData->LeaseTermInMonths;?>">
</div><br>
...
<div class="pro_field_wrapper">
	...
	<textarea rows="4" cols="50" name = "current_residence_address" id="current_residence_address" class="prty_field"><?php echo str_replace("<br>","\n",$this->application->current_residence_address);?></textarea>
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Move In Date </span>    
    <input name="current_residence_move_in_date" type="text" maxlength="65" placeholder="MM/YYYY" id="current_residence_move_in_date" class="prty_field" value="<?php echo $this->application->current_residence_move_in_date;?>">
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Monthly Rent </span>    
    <input name="current_residence_monthly_rent" type="text" maxlength="65" placeholder="Monthly Rent" id="current_residence_monthly_rent" class="prty_field" value="<?php echo $this->application->current_residence_monthly_rent;?>">
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Landlord Name </span>    
    <input name="current_residence_landlord_name" type="text" maxlength="65" placeholder="Landlord Name" id="current_residence_landlord_name" class="prty_field" value="<?php echo $this->application->current_residence_landlordname;?>">
</div> <br>
...
<div class="pro_field_wrapper">
    ...
    <input name="current_residence_landlord_pno" type="text" maxlength="65" placeholder="Landlord Phone Number " id="current_residence_landlord_pno" class="prty_field" value="<?php echo $this->application->current_residence_landlord_pno;?>">
</div> <br>


<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Reason For Leaving </span>    
	<textarea rows="4" cols="50" name = "current_residence_reson_for_leaving" id="current_residence_reson_for_leaving" class="prty_field"><?php echo str_replace("<br>","\n",$this->application->current_residence_leaving_reason);?></textarea>
</div> <br>
...
<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Current Address </span>    
	<textarea rows="4" cols="50" name = "previous_residence_address" id="previous_residence_address" class="prty_field"><?php echo str_replace("<br>","\n",$this->application->previous_residence_address);?></textarea>
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Move In Date </span>    
    <input name="previous_residence_move_in_date" type="text" maxlength="65" placeholder="MM/YYYY" id="previous_residence_move_in_date" class="prty_field" value ="<?php echo $this->application->previous_residence_move_in_date;?>">
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Monthly Rent </span>    
    <input name="previous_residence_monthly_rent" type="text" maxlength="65" placeholder="Monthly Rent" id="previous_residence_monthly_rent" class="prty_field" value ="<?php echo $this->application->previous_residence_monthly_rent;?>">
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Landlord Name </span>    
    <input name="previous_residence_landlord_name" type="text" maxlength="65" placeholder="Landlord Name" id="previous_residence_landlord_name" class="prty_field" value ="<?php echo $this->application->previous_residence_landlord_name;?>">
</div> <br>
...
<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Landlord Phone Number </span>    
    <input name="previous_residence_landlord_pno" type="text" maxlength="65" placeholder="Landlord Phone Number " id="previous_residence_landlord_pno" class="prty_field" value ="<?php echo $this->application->previous_residence_landlord_pno;?>">
</div> <br>


<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Reason For Leaving </span>    
	<textarea rows="4" cols="50" name = "previous_residence_reson_for_leaving" id="previous_residence_reson_for_leaving" class="prty_field" ><?php echo str_replace("<br>","\n",$this->application->previous_residence_leaving_reason);?></textarea>
</div> <br>
...
<div class="pro_field_wrapper">
    ...
    <input name="current_occupation_employer" type="text" maxlength="65" placeholder="Employer" id="current_occupation_employer" class="prty_field" value ="<?php echo $this->application->current_occupation_employer;?>">
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Job Title </span>    
    <input name="current_occupation_job_title" type="text" maxlength="65" placeholder="Product Manager" id="current_occupation_job_title" class="prty_field" value ="<?php echo $this->application->current_occupation_job_title;?>">
</div> <br>
...
<div class="pro_field_wrapper">
    ...
    <input name="current_occupation_monthly_salary" type="text" maxlength="65" placeholder="$" id="current_occupation_monthly_salary" class="prty_field"  value ="<?php echo $this->application->current_occupation_monthly_salary;?>">
</div> <br>
...
<div class="pro_field_wrapper">
    ...
    <input name="current_occupation_manager_name" type="text" maxlength="65" placeholder="Jane Smith" id="current_occupation_manager_name" class="prty_field" value ="<?php echo $this->application->current_occupation_manager_name;?>">
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Phone Number</span>    
    <input name="current_occupation_pno" type="text" maxlength="65" placeholder="(555) 555-5555 ext. 55555" id="current_occupation_pno" class="prty_field" value ="<?php echo $this->application->current_occupation_pno;?>">
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Work Address </span>    
	<textarea rows="4" cols="50" name = "current_occupation_work_address" id="current_occupation_work_address" class="prty_field"> <?php echo str_replace("<br>","\n",$this->application->current_occupation_work_address);?></textarea>
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Start Date</span>    
    <input name="current_occupation_start_date" type="text" maxlength="65" placeholder="MM/YYYY" id="current_occupation_start_date" class="prty_field" value ="<?php echo $this->application->current_occupation_start_date;?>">
</div> <br>
...
<div class="pro_field_wrapper">
    ...
    <input name="current_occupation_income_source" type="text" maxlength="65" placeholder="Investments, etc" id="current_occupation_income_source" class="prty_field" value ="<?php echo $this->application->current_occupation_income_source;?>">
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Monthly Income </span>    
    <input name="current_occupation_monthly_income" type="text" maxlength="65" placeholder="Investments, etc" id="current_occupation_monthly_income" class="prty_field" value ="<?php echo $this->application->current_occupation_monthly_income;?>">
</div> <br>
...
<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Employer </span>    
    <input name="previous_occupation_employer" type="text" maxlength="65" placeholder="Employer" id="previous_occupation_employer" class="prty_field" value ="<?php echo $this->application->previous_occupation_employer;?>">
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Job Title </span>    
    <input name="previous_occupation_job_title" type="text" maxlength="65" placeholder="Product Manager" id="previous_occupation_job_title" class="prty_field" value ="<?php echo $this->application->previous_occupation_job_title;?>">
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Monthly Salary </span>    
    <input name="previous_occupation_monthly_salary" type="text" maxlength="65" placeholder="$" id="previous_occupation_monthly_salary" class="prty_field" value ="<?php echo $this->application->previous_occupation_monthly_salary;?>">
</div> <br>
...
<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Manager's Name</span>    
    <input name="previous_occupation_manager_name" type="text" maxlength="65" placeholder="Jane Smith" id="previous_occupation_manager_name" class="prty_field" value ="<?php echo $this->application->previous_occupation_manager_name;?>">
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Phone Number</span>    
    <input name="previous_occupation_pno" type="text" maxlength="65" placeholder="(555) 555-5555 ext. 55555" id="previous_occupation_pno" class="prty_field" value ="<?php echo $this->application->previous_occupation_pno;?>">
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Work Address </span>    
	<textarea rows="4" cols="50" name = "previous_occupation_work_address" id="previous_occupation_work_address" class="prty_field"><?php echo str_replace("<br>","\n",$this->application->previous_occupation_work_address);?></textarea>
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">End Date</span>    
    <input name="previous_occupation_end_date" type="text" maxlength="65" placeholder="MM/YYYY" id="previous_occupation_end_date" class="prty_field" value ="<?php echo $this->application->previous_occupation_end_date;?>">
</div> <br>
...
<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Income Source </span>    
    <input name="previous_occupation_income_source" type="text" maxlength="65" placeholder="Investments, etc" id="previous_occupation_income_source" class="prty_field" value ="<?php echo $this->application->previous_occupation_income_source;?>">
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Monthly Income </span>    
    <input name="previous_occupation__monthly_income" type="text" maxlength="65" placeholder="Investments, etc" id="previous_occupation__monthly_income" class="prty_field" value ="<?php echo $this->application->previous_occupation__monthly_income;?>">
</div> <br>
...
<div class="pro_field_wrapper">
    ...
    <input name="additional_income_source" type="text" maxlength="65" placeholder="Bonuses, stocks, etc" id="additional_income_source" class="prty_field" value="<?php echo $this->application->additional_income_sources;?>">
</div> <br>

<div class="pro_field_wrapper">
	<span class="prty_lablel pro_label">Amount</span>    
    <input name="additional_income_amount" type="text" maxlength="65" placeholder="$" id="additional_income_amount" class="prty_field" value="<?php echo $this->application->additional_income_amount;?>">
</div> <br>
...
<div class="pro_field_wrapper">
    ...
    <input name="total_monthly_income" type="text" maxlength="65" placeholder="$" id="total_monthly_income" class="prty_field" value="<?php echo $this->application->total_monthly_income;?>">
</div> <br>
...
var current_residence_housing_type ='<?php echo $this->application->current_residence_housing_type?>';
var previous_residence_housing_type ='<?php echo $this->application->previous_residence_housing_type?>';
var current_occupation_status ='<?php echo $this->application->current_occupation_status?>';
var previous_occupation_monthly_status ='<?php echo $this->application->previous_occupation_monthly_status?>';
var current_occupation_work_type ='<?php echo $this->application->current_occupation_work_type?>';
var previous_occupation_work_type ='<?php echo $this->application->previous_occupation_work_type?>';
var LandlordPays ='<?php echo $this->smartmoveapiApplicationData->LandlordPays;?>';
if(LandlordPays == 1){
	LandlordPays = 'true';
}
else{
...
var ProductBundle ='<?php echo $this->smartmoveapiApplicationData->ProductBundle;?>';
...
jQuery("#LandlordPays").val(LandlordPays);
jQuery("#ProductBundle").val(ProductBundle);
			  ...
			  jQuery.ajax({
					 ...
					 success: function (data) { 
                       ...
                       // jQuery( ".succes_message" ).text('Succesfully Saved');
                        ...
                        jQuery('#smartmove_rent').trigger( 'click' );
                        jQuery('.about_me_submit').show(); 
...
/*jQuery('.personal_references_submit').on('click',function(){
 ...
 var oData       = new Object();
	...
	var personal_references_full_name                  = oData.personal_references_full_name =jQuery.trim(jQuery("#personal_references_full_name").val());
	var personal_references_relationship               = oData.personal_references_relationship =jQuery.trim(jQuery("#personal_references_relationship").val());
	var personal_references_address                    = oData.personal_references_address =jQuery.trim(jQuery("#personal_references_address").val().replace(/\n/g, "<br>"));
	var personal_references_phone_no                   = oData.personal_references_phone_no =jQuery.trim(jQuery("#personal_references_phone_no").val());
	
	

 jQuery('.personal_references_submit').hide();
 var host	=	window.location.host;
 ...
 if(is_validate == true){
	    ...
	    jQuery.ajax({
					 ...
					 success: function (data) { 
                        ...
                        jQuery('.personal_references_submit').show(); 
...
jQuery('.rental_application_done').on('click',function(){
 ...
 var property_reqst_id = oData.property_reqst_id = '<?php echo  $this->application->id;?>';
  var tenant_first_name     = jQuery.trim(jQuery("#tenant_first_name").val());  
		 var tenant_last_name      = jQuery.trim(jQuery("#tenant_last_name").val());  
         var tenant_email          = jQuery.trim(jQuery("#tenant_email").val()); 
         
         var Deposit                    =   jQuery.trim(jQuery("#Deposit").val()); 
		 var Rent                       =   jQuery.trim(jQuery("#Rent").val());  
		 var LeaseTermInMonths          =   jQuery.trim(jQuery("#LeaseTermInMonths").val());  
		 var LandlordPays               =   jQuery.trim(jQuery("#LandlordPays").val());  
		 var ProductBundle              =   jQuery.trim(jQuery("#ProductBundle").val()); 
	...
	/*var personal_references_full_name                  = referenceoData.personal_references_full_name =jQuery.trim(jQuery("#personal_references_full_name").val());
	var personal_references_relationship               = referenceoData.personal_references_relationship =jQuery.trim(jQuery("#personal_references_relationship").val());
	var personal_references_address                    = referenceoData.personal_references_address =jQuery.trim(jQuery("#personal_references_address").val().replace(/\n/g, "<br>"));
	var personal_references_phone_no                   = referenceoData.personal_references_phone_no =jQuery.trim(jQuery("#personal_references_phone_no").val());*/
      ...
      var url	=	'<?php echo $this->baseUrl()?>' + '/user/index/saveapplicationreferences';  
	    ...
	    jQuery.ajax({
					...
					success: function (data) { 
						...
						var host	=	window.location.host;
                        var url	=	'<?php echo $this->baseUrl()?>' + '/user/index/editapplicationdone';
					 ...
					 success: function (data) {
                      ...
                      location.href = '<?php echo $this->baseUrl()?>' + '/property/requests';
				       }
				      else{
					   jQuery(".loader").css("display", "none");
