...
<br/>
  ...
  <div id="thumbnail-controller" class="thumbnail-controller">
    ...
    ?>
  </div> <div class="loader signup_umage_upload_loader" style="display:none;"></div>
  <br/>
  ...
  <div>
    ...
    var loader = new Element('img',{ src: baseurl + '/application/modules/Core/externals/images/loading.gif'});;
    var orginalThumbSrc;
    var originalSize;
    var lassoCrop;
  ...
  onResize : lassoSetCoords
    ...
    /*var uploadSignupPhoto =function(){alert(1);
	...
	function uploadSignupPhoto(){
		  ...
		  jQuery('.signup_umage_upload_loader').css('display','block');
