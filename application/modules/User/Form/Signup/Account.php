...
{  
  public function init()
  {
    ...
    $emailElement = $this->addEmailElement(array(
      'label' => 'Email Address',
      'description' => 'Your Email will not be change once you sign up.',
    ...
    $emailElement->getDecorator('Description')->setOptions(array('style' => 'color: #f58410'));
    $emailElement->getValidator('NotEmpty')->setMessage('Please enter email address.', 'isEmpty');
    ...
    if( $settings->getSetting('user.signup.random', 0) == 0 && 
      ...
      $this->addElement('Password', 'password', array(
       'label' => 'Password',
        'description' => 'Password should contain minimum 6 characters with at least a digit, lowercase, uppercase and special charactor.',
    ...
    if( count($topStructure) == 1 && $topStructure[0]->getChild()->type == 'profile_type' ) {
      ...
      if( count($options) > 1 ) {
        ...
        //print_r($options['options']['multiOptions'][6]);exit;
	...
	/*$this->addElement('Select', 'services_type', array_merge( array(
	  'allowEmpty' => false,
	  'tabindex' => $tabIndex++,
	  'label' => 'Services Type',
	//  'multioptions' => array(1 => 'Leagal Aide',2 => 'Process Server', 3 => 'Lawyer', 4 => 'Paralegal'),
	  'multioptions' => array(''=>'Select services type',2 => 'Process Server', 3 => 'Lawyer'),
	  'onchange' => 'showServicesTypes()'
	)));*/
...
//hidden fields for map
   ...
   $this->addElement('Text', 'administrative_area_level_1', array(
   'class'=>'field',
   ...
   $this->addElement('Text', 'sublocality_level_1', array(
   'class'=>'field',
   ...
   $this->addElement('Checkbox', 'locationcheck', array(
    'label'=>'Save as your preferred location',
    'checked'=>'checked',
    'value'=>0,
    'class'=>'field',
    'id'=>'locationcheck',
