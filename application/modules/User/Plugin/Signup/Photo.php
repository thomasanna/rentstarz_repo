...
class User_Plugin_Signup_Photo extends Core_Plugin_FormSequence_Abstract
{
  ...
  public function onSubmit(Zend_Controller_Request_Abstract $request)
  {
    ...
    if( $this->getForm()->isValid($request->getPost()) &&
      ...
      return false;
        ...
        $finishForm == "finish" &&
        isset($_SESSION['TemporaryProfileImg']) && $uploadPhoto == true ) {
      ...
      return true;
        ...
        (!isset($_SESSION['TemporaryProfileImg']) && $finishForm == "finish") && $uploadPhoto == true) {
      $this->setActive(false);
      $this->onSubmitIsValid();
  ...
  public function onProcess()
  {
    ...
    unset($_SESSION['TemporaryProfileImgPassport']);
  ...
  protected function _resizeImages($file)
  {
    ...
    if( empty($this->getSession()->tmp_file_id) ) {
      ...
      $iPassport = $storage->createTemporaryFile($iPassportPath);
      
      $iMain->bridge($iProfile, 'thumb.profile');
      $iMain->bridge($iNormal, 'thumb.normal');
      $iMain->bridge($iSquare, 'thumb.icon');
      $iMain->bridge($iPassport, 'thumb.passport');
      ...
      $iPassport = $storage->getFile($this->getSession()->tmp_file_id, 'thumb.passport');
      $iPassport->store($iPassportPath);
    }
    ...
    $_SESSION['TemporaryProfileImgPassport'] = $iPassport->map();
