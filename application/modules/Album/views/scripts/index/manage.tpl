...
?>
<script>
jQuery('#global_page_album-index-manage .headline h2').append('<span><img style="padding-bottom: 11px; margin-top: 4px;" src="/application/modules/User/externals/images/gallery.svg"></span>');
</script>
