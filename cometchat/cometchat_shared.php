...
function sendChatroomMessage($to = 0,$message = '',$notsilent = 1) {
	...
	if(strpos($message,'BROADCAST_ENDCALL')!==false || strpos($message,'jqcc.ccbroadcast.join')!==false){
		include_once (dirname(__FILE__).DIRECTORY_SEPARATOR."plugins".DIRECTORY_SEPARATOR."broadcast".DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR."en.php");
    	...
    	include_once (dirname(__FILE__).DIRECTORY_SEPARATOR."plugins".DIRECTORY_SEPARATOR."avchat".DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR."en.php");
    	...
    	include_once (dirname(__FILE__).DIRECTORY_SEPARATOR."plugins".DIRECTORY_SEPARATOR."audiochat".DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR."en.php");
    	...
    	include_once (dirname(__FILE__).DIRECTORY_SEPARATOR."plugins".DIRECTORY_SEPARATOR."stickers".DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR."en.php");
    	...
    	include_once (dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR."chatrooms".DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR."en.php");
    	...
    	include_once (dirname(__FILE__).DIRECTORY_SEPARATOR."plugins".DIRECTORY_SEPARATOR."whiteboard".DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR."en.php");
    	...
    	include_once (dirname(__FILE__).DIRECTORY_SEPARATOR."plugins".DIRECTORY_SEPARATOR."writeboard".DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR."en.php");
    	...
    	include_once (dirname(__FILE__).DIRECTORY_SEPARATOR."plugins".DIRECTORY_SEPARATOR."screenshare".DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR."en.php");
    	...
    	include_once (dirname(__FILE__).DIRECTORY_SEPARATOR."plugins".DIRECTORY_SEPARATOR."handwrite".DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR."en.php");
    	...
    	include_once (dirname(__FILE__).DIRECTORY_SEPARATOR."plugins".DIRECTORY_SEPARATOR."filetransfer".DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR."en.php");
...
function getChatroomDetails($id=0) {
	...
	$response =array();
	if(!empty($_GET['action']) && $_GET['action'] == 'getChatroomDetails' && !empty($_REQUEST['id'])){
		$id = $_REQUEST['id'];
	}
	if(empty($id)){
